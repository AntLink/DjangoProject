	...
	var layerSlider = function(el, options) {
		...
		ls.load = function(){
			...
			if( !ls.g.initialized ){
				...
				if( !ls.o.skin || ls.o.skin == '' || !ls.o.skinsPath || ls.o.skinsPath == '' ){
					...
					var skinStyle = window.location.host + ls.o.skinsPath+ls.o.skin+'/skin.css';
		...
		ls.init = function(){
			...
			$(el).find('.ls-slide img').each(function(){
				...
				if( ls.o.imgPreload === true && ls.o.lazyLoad === true ){
					...
					if( typeof $(this).data('src') !== 'string' ){
						...
						var src = window.location.host + ls.o.skinsPath+'../css/blank.gif';
						$(this).attr('src',src);
					}
				}else{
					if( typeof $(this).data('src') === 'string' ){
								...
								function(){
									...
									if( ls.o.imgPreload === true && ls.o.lazyLoad === true ){
										...
										if( hoverLayer.find('.ls-tn').length ){
											...
											tnSrc = window.location.host + ls.o.skinsPath+ls.o.skin+'/nothumb.png';
										}
									}else{
			...
			if( ls.g.shadow.css('display') == 'block' && !ls.g.shadow.find('img').length ){
				...
				ls.g.shadowImg = $('<img>').attr('src',window.location.host + ls.o.skinsPath+ls.o.skin+'/shadow.png').appendTo( ls.g.shadow );
