...
!function (n) {
    ...
    var t, e = function (t) {
            if (!t.data("nifty-check")) {
                ...
                //e.checked ? t.addClass("active") : t.removeClass("active")
            }
        },
        i = {
            isChecked: function () {
    ...
    n.fn.niftyCheck = function (t) {
        ...
        var input = $('.form-checkbox').find('input').attr('checked');
        if (input == 'checked') {
            $(input).parent().addClass('active');
        }
        $('.form-cat').on('click', function () {
            var inp = $(this).find('input[type=checkbox]');
            var status = $(inp).parent().hasClass('disabled');

            if (status == false) {
                if ($(this).find(inp).attr('checked') == 'checked') {
        ...
        $('.menu-form-cat').on('click', function () {
            var inp = $(this).find('input[type=checkbox]');
            var status = $(inp).parent().hasClass('disabled');
            if (status == 'false') {
                if ($(this).find(inp).attr('checked') == 'checked') {
        ...
        $('.action-checkbox-column').find('input').on('click', function () {
            var input = $('.action-checkbox').find('input[type=checkbox]').attr('checked');
            if (input != 'checked') {
                $('.action-checkbox').find('label').addClass('active');
                $('.action-checkbox').find('input[type=checkbox]').attr('checked', 'checked');
            } else {
                $('.action-checkbox').find('label').removeClass('active');
                $('.action-checkbox').find('input[type=checkbox]').removeAttr('checked');
            }
        });
